...
$cfg_version = 'V10_UTF-8';
$cfg_soft_lang = 'utf-8';
$cfg_soft_public = 'base';

$cfg_softname = '辅稳软件内容管理系统';
$cfg_soft_enname = 'FlywetCMS';
...
$cfg_indexname = '辅稳软件';
$cfg_webname = '辅稳软件';
$cfg_adminemail = 'admin@flywetba.com';
...
$cfg_multi_site = 'N';
$cfg_flywet_log = 'N';
$cfg_powerby = 'Copyright &copy; 2013 FLYWET. 辅稳软件 版权所有';
$cfg_arcsptitle = 'N';
$cfg_arcautosp = 'N';
...
$cfg_smtp_server = 'smtp.flywetba.com';
$cfg_smtp_port = '25';
$cfg_smtp_usermail = 'service@flywetba.com';
$cfg_smtp_user = 'service';
$cfg_smtp_password = 'service1234';
$cfg_online_type = 'nps';
$cfg_upload_switch = 'Y';
$cfg_allsearch_limit = '1';
$cfg_rewrite = 'N';
$cfg_delete = 'Y';
$cfg_keywords = '辅稳,辅稳软件,商业分析,报表,多维,大数据,数据可视化,云平台,BI,BA,DI,ETL,Dashboard,BI IOS,BI Android';
$cfg_description = '辅稳软件技术有限公司（以下简称辅稳软件）是专注于企业级大规模数据应用与服务的高新技术企业，辅稳软件致力于科技创新和前沿技术转换，推动企业级应用软件的更新换代，深度发掘企业自身资源价值，提供高效而精准的决策信息。辅稳软件的愿景：度身为企业客户打造全方位的新一代的商业分析信息化解决方案。';
$cfg_beian = '';
$cfg_need_typeid2 = 'Y';
$cfg_cache_type = 'id';
$cfg_max_face = 50;

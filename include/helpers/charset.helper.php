...
if ( ! function_exists('utf82gb'))
{
    function utf82gb($utfstr)
    {
        ...
        if(empty($UC2GBTABLE))
        {
            $filename = FLYWETINC."/data/gb2312-utf8.dat";
            $fp = fopen($filename,"r");
            while($l = fgets($fp,15))
            {
...
if ( ! function_exists('big52gb'))
{
    function big52gb($Text)
    {
        ...
        if(empty($BIG5_DATA))
        {
            $filename = FLYWETINC."/data/big5-gb.dat";
...
if ( ! function_exists('gb2big5'))
{
    function gb2big5($Text)
    {
        ...
        if(empty($GB_DATA))
        {
            $filename = FLYWETINC."/data/gb-big5.dat";
            $fp = fopen($filename, "rb");
...
if ( ! function_exists('UnicodeUrl2Gbk'))
{
    function UnicodeUrl2Gbk($str)
    {
        ...
        {
            $fp = fopen(FLYWETINC.'/data/gbk-unicode.dat','rb');
            while(!feof($fp))
            {

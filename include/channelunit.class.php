 ...
 * 频道模型单元类
 */
require_once(FLYWETINC."/flywettag.class.php");
...
class ChannelUnit
{
    ...
    {        
        ...
        else if(file_exists(FLYWETINC.'/taglib/channel/'.$ftype.'.lib.php'))
        {
            include_once(FLYWETINC.'/taglib/channel/'.$ftype.'.lib.php');
            $func = 'ch_'.$ftype;
